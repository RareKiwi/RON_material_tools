...
3. Either:
	...
	* b) Edit EUW_MaterialTools and change the 'Text' of EditableTextBox_tgaPath permanently to your specific 'game' umodel export directory with the correct forward slashes, then compile and save the widget and Right-Click > Run it
4. 